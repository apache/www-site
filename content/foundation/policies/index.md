...
- [Handling Cryptography within an ASF Release](https://infra.apache.org/crypto.html) — Cryptography export notification requirements
- [Release Download Pages Policy](https://infra.apache.org/release-download-pages.html) — Requirements for project release download pages
- [Docker Hub Policy](https://infra.apache.org/docker-hub-policy.html) — Policy for Apache projects publishing to Docker Hub
- [CLA FAQ](/foundation/license-faq.html) — Frequently asked questions about Contributor License Agreements
...
- [Trademark Maintenance Responsibilities](/foundation/marks/responsibility.html) — PMC responsibilities for maintaining Apache trademarks
- [Apache Product Name Usage Guide](/foundation/marks/guide.html) — How to correctly refer to Apache brands in text
- [Apache Trademark FAQs](/foundation/marks/faq.html) — Permitted and prohibited uses of Apache marks
- [Registered Trademarks List](/foundation/marks/list.html) — Authoritative list of ASF word marks and registered trademarks
- [Incubator Podling Branding Guide](https://incubator.apache.org/guides/branding.html) — Branding requirements for podlings
...
- [Privacy Policy for Contributors](https://privacy.apache.org/policies/privacy-policy-contributors.html) — Privacy policy specific to ASF contributors
- [Privacy Policy for Committers](https://privacy.apache.org/policies/privacy-policy-committer.html) — Privacy policy specific to ASF committers
- [Mailing List Privacy Policy](https://privacy.apache.org/policies/mailinglist-policy.html) — Privacy policy for ASF public mailing lists
...
- [Project Independence](https://community.apache.org/projectIndependence.html) — Guidelines for operating independently and for the public good
- [ASF Bylaws](/foundation/bylaws.html) — Foundation bylaws covering membership, directors, officers, PMCs
- [Incubator Podling Policies](https://incubator.apache.org/policy/incubation.html) — Policies governing Apache Incubator podlings
...
- [GitHub Actions Policy](https://infra.apache.org/github-actions-policy.html) — Policy for Apache projects using GitHub Actions
- [Slack Policy](https://infra.apache.org/slack-policy.html) — Policy for using ASF Slack workspaces
- [Content Moderation](https://infra.apache.org/content-moderation.html) — Infrastructure content moderation policy
- [Site-Wide Ban Policy](https://infra.apache.org/infra-ban.html) — Infrastructure policy for site-wide bans
